...
int main()
{
    ...
    // -------------------------
    Shader shader("supporting/cube.vs", "supporting/cube.fs");
    Shader simpleDepthShader("supporting/sample_depth.vs", "supporting/sample_depth.fs");
    Shader lightShader("supporting/light.vs", "supporting/light.fs");
    // load textures
    // -------------
